...
| Expansion Valve | `TOP142` | steps | — | mdi:valve | measurement | <pre lang="yaml"><code>sensor:&#13;  - platform: panasonic_aquarea&#13;    top: 142</code></pre> |
...
| Heater On Outdoor Temp | `SET46` | temperature | -15 | 20 | — | <pre lang="yaml"><code>number:&#13;  - platform: panasonic_aquarea&#13;    set: 46</code></pre> |
...
| Heating Control | `SET39` | mdi:tune | <ul><li>Comfort</li><li>Efficiency</li></ul> | <pre lang="yaml"><code>select:&#13;  - platform: panasonic_aquarea&#13;    set: 39</code></pre> |
| Smart DHW | `SET40` | mdi:water-boiler | <ul><li>Standard</li><li>Variable</li></ul> | <pre lang="yaml"><code>select:&#13;  - platform: panasonic_aquarea&#13;    set: 40</code></pre> |
| Quiet Mode Priority | `SET41` | mdi:sleep | <ul><li>Capacity</li><li>Sound</li></ul> | <pre lang="yaml"><code>select:&#13;  - platform: panasonic_aquarea&#13;    set: 41</code></pre> |
| Pump Flowrate Mode | `SET42` | mdi:pump | <ul><li>DeltaT</li><li>Max flow</li></ul> | <pre lang="yaml"><code>select:&#13;  - platform: panasonic_aquarea&#13;    set: 42</code></pre> |
| DHW Sensor Selection | `SET43` | mdi:thermometer | <ul><li>Center</li><li>Top</li></ul> | <pre lang="yaml"><code>select:&#13;  - platform: panasonic_aquarea&#13;    set: 43</code></pre> |
...
| Name | Heishamon ID | Icon | Options | Example |
|------|--------------|------|---------|---------|
| Three-way Valve State | `TOP20` | mdi:pipe-valve | <ul><li>DHW Tank</li><li>Room</li></ul> | <pre lang="yaml"><code>text_sensor:&#13;  - platform: panasonic_aquarea&#13;    top: 20</code></pre> |
...
| Three-way Valve State 2 | `TOP126` | mdi:pipe-valve | <ul><li>DHW Tank</li><li>Room</li></ul> | <pre lang="yaml"><code>text_sensor:&#13;  - platform: panasonic_aquarea&#13;    top: 126</code></pre> |
...
| Stop Pump Max Speed | `SET14:0` | <pre lang="yaml"><code>button:&#13;  - platform: panasonic_aquarea&#13;    set: "14:0"</code></pre> |
| Set Pump Max Speed | `SET14:1` | <pre lang="yaml"><code>button:&#13;  - platform: panasonic_aquarea&#13;    set: "14:1"</code></pre> |
| Reset Error | `SET48` | <pre lang="yaml"><code>button:&#13;  - platform: panasonic_aquarea&#13;    set: 48</code></pre> |
...
| DHW Heater Allowed | `SET44` | <pre lang="yaml"><code>switch:&#13;  - platform: panasonic_aquarea&#13;    set: 44</code></pre> |
| Room Heater Allowed | `SET45` | <pre lang="yaml"><code>switch:&#13;  - platform: panasonic_aquarea&#13;    set: 45</code></pre> |
| Force Heater | `SET47` | <pre lang="yaml"><code>switch:&#13;  - platform: panasonic_aquarea&#13;    set: 47</code></pre> |