...
namespace esphome
{
    namespace wmbus_radio
    {
        ...
        void SXRadio::set_reset_pin(InternalGPIOPin *reset_pin)
        {
            this->reset_pin_ = reset_pin;
        }

        void SXRadio::set_irq_pin(InternalGPIOPin *irq_pin)
        {
        ...
        void SXRadio::attach_interrupt_impl(void (*callback)(void *), void *arg)
        {
            if (this->irq_pin_ == nullptr)
                return;
