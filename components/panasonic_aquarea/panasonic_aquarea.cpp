...
namespace esphome
{
    namespace panasonic_aquarea
    {
        ...
        void Device::set_external_controller_uart(uart::UARTComponent *controller)
        {
            this->external_controller_ = controller;
        }
        ...
        void Device::process_external_controller_data()
        {
            ...
            if (this->comm_state_ == CommunicationState::EXTERNAL_TRANSACTION ||
        ...
        {
            auto entities_count = std::distance(this->standard_response_entities_.cbegin(), this->standard_response_entities_.cend()) +
